...
pub struct Options {
  #[clap(long, help = "Load Wojakcoin Core data dir from <WOJAKCOIN_DATA_DIR>.")]
  ...
  #[clap(long, help = "Load Wojakcoin Core RPC cookie file from <COOKIE_FILE>.")]
  ...
  #[clap(long, help = "Connect to Wojakcoin Core RPC at <RPC_URL>.")]
