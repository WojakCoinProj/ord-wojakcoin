...
"
  ...
  fn page_mainnet() {
    assert_regex_match!(
      ...
      r".*<nav>\s*<a href=/>ordwoj<sup>beta</sup></a>.*"
    );
  }
  ...
  fn page_no_sat_index() {
    assert_regex_match!(
      ...
      r".*<nav>\s*<a href=/>ordwoj<sup>beta</sup></a>.*\s*<form action=/search.*",
    );
  }
  ...
  fn page_signet() {
    assert_regex_match!(
      ...
      r".*<nav>\s*<a href=/>ordwoj<sup>signet</sup></a>.*"
    );
  }
}
